...
const CarShoppingPage = () => {
  ...
  const getUserImg = (userReview) => {
    try {
      getUser(userReview).then((response) => {
  ...
  const formatDate = (date) => {
    ...
    const diffDias = Math.floor(
      now.diff(fechaObjetivo, "days").toObject().days
    );
    ...
    <section className="shopping_page">
      {isLoading ? (
        ...
        <div className="shopping_page_modal">
          <div
            className="shopping_page_modal_div1"
          ...
          >
            ...
            <div className="point_container">
              {pizza
                ? Object.keys(pizza.images).map((propiedad) => (
                    <div
                      key={propiedad}
                      className="point"
                      style={{
                        backgroundColor:
                          photo === pizza.images[propiedad]
                            ? "#ffffff"
                            : "#8f8f8f",
                      }}
                      value={pizza.images[propiedad]}
                      onClick={(e) => handlePizzaPhoto(e)}
                    ></div>
                  ))
                : ""}
            </div>
          ...
          <div className="shopping_page_modal_div2">
            <section className="top">
              ...
              <div className="price_reviews">
                <div className="price_reviews_div1">
                  <span>
                    $ {pizza ? formatPrice(pizza.price) : ""}
                    <>&nbsp;</>
                  </span>
                  COP
                </div>
                <div className="price_reviews_div2">
                  ...
                  <p>
                    ...
                    {pizza?.reviews.length > 1 ? "Reviews" : "Review"}
                  </p>
                </div>
              </div>
              <h3>Descripción</h3>
              ...
              <section className="review">
                <figure>
                  <img
                    ...
                    alt="Imagen de perfil usuario del review"
                    className="figure_user_review"
                  />
                </figure>
                <div className="review_div">
                  <div className="review_name_date">
                    ...
                    <span>
                      {pizza ? formatDate(pizza?.reviews[0].date) : ""}
                    </span>
                  </div>
            ...
            <section className="car">
              ...
              <div>
                <button
                  className="car_shopping_basket"
                  type="button"
                  onClick={handleBasket}
                >
                  <img
                    src={pizzaBasket ? shopping_basket_full : shopping_basket}
                    alt="Icono cesta de compra"
                  />
                </button>
                <button
                  className="car_order"
